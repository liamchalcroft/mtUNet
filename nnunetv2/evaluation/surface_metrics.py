"""
This module is derived from the surface distance metrics implementation
available at https://github.com/google-deepmind/surface-distance/blob/master/surface_distance/metrics.py.

It provides functions for computing surface distance-based measures.
"""
...
from nnunetv2.evaluation import lookup_tables
import numpy as np
