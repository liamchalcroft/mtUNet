...
available at https://github.com/google-deepmind/surface-distance/blob/master/surface_distance/lookup_tables.py.

It provides lookup tables used by surface distance metrics.
"""
