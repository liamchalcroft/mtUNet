...
class DefaultPreprocessor(object):
    ...
    def run_case_save(self, output_filename_truncated: str, image_files: List[str], seg_file: str,
                      plans_manager: PlansManager, configuration_manager: ConfigurationManager,
                      dataset_json: Union[dict, str], subtype_map: np.ndarray):
        data, seg, properties = self.run_case(image_files, seg_file, plans_manager, configuration_manager, dataset_json, subtype_map)
    ...
    def run(self, dataset_name_or_id: Union[int, str], configuration_name: str, plans_identifier: str,
        ...
        subtype_csv = join(nnUNet_raw, dataset_name, 'train_subtypes.csv')
        subtype_map = np.loadtxt(subtype_csv, dtype=str, delimiter=',')
