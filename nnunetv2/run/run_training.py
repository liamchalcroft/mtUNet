...
from nnunetv2.training.nnUNetTrainer.nnUNetMultiTaskTrainer import nnUNetMultiTaskTrainer
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
                          configuration: str,
                          fold: int,
                          trainer_name: str = 'nnUNetMultiTaskTrainer',
    ...
    assert issubclass(nnunet_trainer, nnUNetMultiTaskTrainer), 'The requested nnunet trainer class must inherit from ' \
                                                    'nnUNetMultiTaskTrainer'
...
def maybe_load_checkpoint(nnunet_trainer: nnUNetMultiTaskTrainer, continue_training: bool, validation_only: bool,
...
def run_training(dataset_name_or_id: Union[str, int],
                 ...
                 trainer_class_name: str = 'nnUNetMultiTaskTrainer',
                 plans_identifier: str = 'nnUNetPlans',
...
def run_training_entry():
    ...
    parser.add_argument('-tr', type=str, required=False, default='nnUNetMultiTaskTrainer',
                        help='[OPTIONAL] Use this flag to specify a custom trainer. Default: nnUNetMultiTaskTrainer')
